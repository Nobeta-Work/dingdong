...
public final class ProductResponses {
    ...
    public record ProductSummary(Long id,String title,String subtitle,String mainImageUrl,Long categoryId,Long brandId,Integer status,BigDecimal minPrice,Integer sales,LocalDateTime createdAt) { public static ProductSummary from(ProductSpu v){return new ProductSummary(v.getId(),v.getTitle(),v.getSubtitle(),v.getMainImageUrl(),v.getCategoryId(),v.getBrandId(),v.getStatus(),v.getMinPrice(),v.getSales(),v.getCreatedAt());} }
